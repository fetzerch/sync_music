...
class TestTranscode:
    ...
    def test_transcode_transcode(self):
        ...
        self.execute_transcode(
            Transcode(mode="transcode"), in_filename=self.in_filename_mp3
        )

    def test_transcode_replaygain(self):
        """Tests transcoding with ReplayGain (track based)."""
        self.execute_transcode(
            Transcode(mode="replaygain"), in_filename=self.in_filename_mp3all
        )
        self.execute_transcode(
            Transcode(mode="replaygain"), in_filename=self.in_filename_mp3
        )

    def test_transcode_replaygainalbum(self):
        """Tests transcoding with ReplayGain (album based)."""
        self.execute_transcode(
            Transcode(mode="replaygain-album", replaygain_preamp_gain=10.0),
    ...
    def test_transcode_artist_hack(self):
        ...
        self.execute_transcode(
            Transcode(albumartist_artist_hack=True),
    ...
    def test_transcode_composer_hack(self):
        ...
        self.execute_transcode(
            Transcode(albumartist_composer_hack=True),
            in_filename=self.in_filename_mp3empty,
        )
    ...
    def test_transcode_artist_albumartist_hack(self):
        ...
        self.execute_transcode(
            Transcode(artist_albumartist_hack=True),
            in_filename=self.in_filename_mp3empty,
        )
    ...
    def test_transcode_discnumber_hack(self):
        ...
        self.execute_transcode(
            Transcode(discnumber_hack=True), in_filename=self.in_filename_mp3all
        )
    ...
    def test_transcode_tracknumber_hack(self):
        ...
        self.execute_transcode(
            Transcode(tracknumber_hack=True), in_filename=self.in_filename_mp3empty
        )
        self.execute_transcode(
            Transcode(tracknumber_hack=True), in_filename="brokentag_tracknumber.mp3"
        )
    ...
    def test_transcodingerror_format(self):
        ...
        with pytest.raises(IOError):
            self.execute_transcode(Transcode(), in_filename=self.in_filename_aiff)
