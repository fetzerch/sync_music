...
class TestSyncMusicFiles:
    ...
    def test_reference_cleanup(self):
        ...
        output_files = ["stripped_mp3.mp3", "sync_music.db"]
    ...
    def test_reference_forcecopy(self):
        ...
        self._execute_sync_music(output_files=output_files, arguments=["--mode=copy"])
    ...
    def test_reference_ioerror(self, mocker):
        ...
        mocker.patch(
            "sync_music.transcode.Transcode.execute",
